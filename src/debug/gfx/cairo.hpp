...
inline Exception::Exception(status_t code) : m_code {code}
{}
...
inline Cairo::Cairo() : m_raw {nullptr}
{}

inline Cairo::Cairo(gsl::owner<cairo_t *> raw) : m_raw {raw}
{}
...
inline Cairo::Cairo(Cairo &&other) : m_raw {std::exchange(other.m_raw, nullptr)}
{}
...
inline Surface::Surface() : m_raw {nullptr}
{}

inline Surface::Surface(gsl::owner<cairo_surface_t *> raw) : m_raw {raw}
{}
...
inline Surface::Surface(Surface &&other) : m_raw {std::exchange(other.m_raw, nullptr)}
{}
...
inline Pattern::Pattern() : m_raw {}
{}

inline Pattern::Pattern(gsl::owner<cairo_pattern_t *> raw) : m_raw {raw}
{}
...
inline Pattern::Pattern(Pattern &&other) : m_raw {std::exchange(other.m_raw, nullptr)}
{}
...
inline Matrix::Matrix() : m_raw {}
{}

inline Matrix::Matrix(cairo_matrix_t m) : m_raw {m}
{}
...
template <class T> constexpr auto pixel_format() -> Format;

template <> inline constexpr auto pixel_format<Srgba>() -> Format
{
	return Format::Rgba128f;
}

template <> inline constexpr auto pixel_format<Srgb>() -> Format
{
